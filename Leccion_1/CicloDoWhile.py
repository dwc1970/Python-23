...
# Cambiar el color de fondo y los bordes de la ventana
ventana.configure(bg="#87CEEB")
ventana.configure(highlightbackground="black", highlightthickness=1)
...
# Cambiar el color de fondo y los bordes de los cuadros de texto
resultado_while.configure(bg="white", highlightbackground="black", highlightthickness=1)
resultado_do_while.configure(bg="white", highlightbackground="black", highlightthickness=1)
